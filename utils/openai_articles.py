...
def answer_the_question(user_input, related_articles_combined):
    system_prompt = ""You are a chatbot that answers question regarding the provided articles of the Family Code of the Philippines. Your goal is to answer the queries concisely and simply, in layman’s terms.""
